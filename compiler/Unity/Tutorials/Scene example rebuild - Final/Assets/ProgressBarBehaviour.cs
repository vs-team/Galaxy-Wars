...
namespace ProgressBar
{
  public class ProgressBarBehaviour : MonoBehaviour, IIncrementable, IDecrementable
  {
    public static ProgressBarBehaviour Instantiate()
    {
      ...
      j.SetFillerSize(0);
      j.fillerbg = GameObject.Find("ProgressBarLabelInside/FillerBg").GetComponent<Image>();
      j.filler = GameObject.Find("ProgressBarLabelInside/Filler").GetComponent<Image>();
      j.Label = GameObject.Find("ProgressBarLabelInside/Label").GetComponent<Text>();
      return j;
    }

    private Image fillerbg;
    ...
    public bool Destroyed
    {
      ...
      set
      {
        destroyed = value;
        if (destroyed)
          GameObject.Destroy(GameObject.Find("ProgressBarLabelInside"));
      }
    }
    ...
    public int pspeed
    {
      ...
      set
      {
        ...
        else
        {
          ...
          {
            ProgressSpeed = value;
            GameObject.Find("ProgressBarLabelInside").GetComponent<Image>().gameObject.SetActive(true);
            fillerbg.gameObject.SetActive(true);
    ...
    void Update()
    {
      if (TransitoryValue == 0 && fillerbg.gameObject.activeInHierarchy)
      {
        //GameObject.Find("ProgressBarLabelInside").GetComponent<Image>().gameObject.SetActive(false);
        fillerbg.gameObject.SetActive(false);
      ...
      if (TransitoryValue != m_Value.AsFloat && TransitoryValue != 100)
      {
        ...
        if (Dvalue > 0)
        {
          TransitoryValue += ProgressSpeed * 0.015f;
