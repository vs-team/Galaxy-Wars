...
public void Start()
	{
		Truck ___truk00;
		___truk00 = new Truck("zpickup",new UnityEngine.Vector3(0f,-6.99f,0f),false,(
...
(new Cons<Player>(new Player(1),(new Empty<Player>()).ToList<Player>())).ToList<Player>()).ToList<Player>();
		LastAddedGasStationPosition = new UnityEngine.Vector3(0f,0f,0f);
		Landscapes = (

(new Cons<Landscape>(new Landscape(new UnityEngine.Vector3(0f,0f,-160f),1),(new Cons<Landscape>(new Landscape(new UnityEngine.Vector3(0f,0f,-80f),3),(new Cons<Landscape>(new Landscape(Vector3.zero,2),(new Empty<Landscape>()).ToList<Landscape>())).ToList<Landscape>())).ToList<Landscape>())).ToList<Landscape>()).ToList<Landscape>();
...
Enumerable.Empty<Gasstation>()).ToList<Gasstation>();
 ...
 foreach(var e in value){if(e.JustEntered){ e.JustEntered = false;
	...
	public UnityEngine.Vector3 LastAddedGasStationPosition;
 ...
 foreach(var e in value){if(e.JustEntered){ e.JustEntered = false;
  ...
  set{UnityLandscape.useGUILayout = value; }
	...
	public List<Landscape> ___x40;
	public List<Landscape> ___q40;
	public UnityEngine.Transform ___g40;
	public ZombieGroupDestroyer ___j40;
	public System.Single count_down1;
	public ZombieGroupDestroyer ___z40;
	public System.Single count_down2;
	public List<Zombie> ___zmbies50;
	public List<GroupZombie> ___groups60;
	public List<Zombie> ___zombiegroup60;
	public List<GroupZombie> ___groups71;
	public List<Zombie> ___zombiegroup71;
	public System.Single ___x91;
	public List<Gasstation> ___j101;
	public System.Boolean ___t100;
...
(Gasstations).Select(__ContextSymbol6 => new { ___b00 = __ContextSymbol6 })
.Where(__ContextSymbol7 => !(((__ContextSymbol7.___b00.Destroyed) == (true))))
...
.ToList<Landscape>()).ToList<Landscape>();
	...
	goto case 3;	}
	case 2:
	if(((___ls10.Head().Position.z) > (LastAddedGasStationPosition.z)))
	{

	___Headpos10 = LastAddedGasStationPosition;	}else
	{

	___Headpos10 = ___ls10.Head().Position;	}
	if(((Counter) > (9)))
	{
	...
	LastAddedGasStationPosition = new UnityEngine.Vector3(0f,0f,(___Headpos10.z) - (80f));
	s1 = 8;
return;
	case 8:
...
return;	}
	...
	LastAddedGasStationPosition = LastAddedGasStationPosition;
	s1 = 11;
return;
	case 11:
	Landscapes = Landscapes;
...
return;	}
	...
	LastAddedGasStationPosition = new UnityEngine.Vector3(0f,0f,(___Headpos11.z) - (80f));
	s1 = 17;
return;
	case 17:
...
(Landscapes).Select(__ContextSymbol11 => new { ___a21 = __ContextSymbol11 })
.SelectMany(__ContextSymbol12=> (__ContextSymbol12.___a21.PickUps).Select(__ContextSymbol13 => new { ___b21 = __ContextSymbol13,
                                                      prev = __ContextSymbol12 })
.SelectMany(__ContextSymbol14=> (__ContextSymbol14.___b21.BonusAndResources).Select(__ContextSymbol15 => new { ___c20 = __ContextSymbol15,
                                                      prev = __ContextSymbol14 })
.Where(__ContextSymbol16 => __ContextSymbol16.___c20.Active)
.Select(__ContextSymbol17 => __ContextSymbol17.___c20.NameOfBoR)
...
return;	}
	case 31:
	world.Jeep.Value.Fuel = ((world.Jeep.Value.Fuel) + (4000f));
	world.Jeep.Value.Stats.Health = ((world.Jeep.Value.Stats.Health) + (20f));
	world.Jeep.Value.CarHP2 = ((world.Jeep.Value.Stats.Health) / (100f));
	s3 = -1;
return;	
	default: return;}}
...
(Landscapes).Select(__ContextSymbol18 => new { ___a43 = __ContextSymbol18 })
.Where(__ContextSymbol19 => ((UnityEngine.Vector3.Distance(__ContextSymbol19.___a43.Position,Jeep.Value.Position)) > (400)))
.Select(__ContextSymbol20 => __ContextSymbol20.___a43)
.ToList<Landscape>()).ToList<Landscape>();
	if(((___x40.Count) > (0)))
	{
...
(Landscapes).Select(__ContextSymbol21 => new { ___a44 = __ContextSymbol21 })
.Where(__ContextSymbol22 => ((400) > (UnityEngine.Vector3.Distance(__ContextSymbol22.___a44.Position,Jeep.Value.Position))))
.Select(__ContextSymbol23 => __ContextSymbol23.___a44)
.ToList<Landscape>()).ToList<Landscape>();
	___g40 = ___x40.Head().transform;
	___j40 = new ZombieGroupDestroyer(___g40.position.z,Jeep.Value.Position);
	ZombiegroupDest = (new Just<ZombieGroupDestroyer>(___j40));
	Landscapes = ___q40;
	s4 = 4;
return;
	case 4:
...
return;
	case 1:
	___z40 = new ZombieGroupDestroyer(10f,Jeep.Value.Position);
	ZombiegroupDest = (new Just<ZombieGroupDestroyer>(___z40));
	Landscapes = Landscapes;
	s4 = 11;
return;
	case 11:
...
(Zombies).Select(__ContextSymbol24 => new { ___a55 = __ContextSymbol24 })
.Where(__ContextSymbol25 => ((__ContextSymbol25.___a55.Destroyed) == (false)))
.Select(__ContextSymbol26 => __ContextSymbol26.___a55)
...
(Landscapes).Select(__ContextSymbol27 => new { ___a66 = __ContextSymbol27 })
.SelectMany(__ContextSymbol28=> (__ContextSymbol28.___a66.Group).Select(__ContextSymbol29 => new { ___b62 = __ContextSymbol29,
                                                      prev = __ContextSymbol28 })
.Select(__ContextSymbol30 => __ContextSymbol30.___b62)
.ToList<GroupZombie>())).ToList<GroupZombie>();
	___zombiegroup60 = (

(___groups60).Select(__ContextSymbol31 => new { ___a67 = __ContextSymbol31 })
.SelectMany(__ContextSymbol32=> (__ContextSymbol32.___a67.ZombieFollowers).Select(__ContextSymbol33 => new { ___c61 = __ContextSymbol33,
                                                      prev = __ContextSymbol32 })
.Select(__ContextSymbol34 => __ContextSymbol34.___c61)
.ToList<Zombie>())).ToList<Zombie>();
	if(((___zombiegroup60.Count) > (0)))
	{
...
return;	}
	case 3:
	Zombies = (___zombiegroup60).Concat(Zombies).ToList<Zombie>();
	s6 = -1;
return;	
	default: return;}}
...
(Gasstations).Select(__ContextSymbol35 => new { ___a78 = __ContextSymbol35 })
.SelectMany(__ContextSymbol36=> (__ContextSymbol36.___a78.GroupZombies).Select(__ContextSymbol37 => new { ___b73 = __ContextSymbol37,
                                                      prev = __ContextSymbol36 })
.Select(__ContextSymbol38 => __ContextSymbol38.___b73)
.ToList<GroupZombie>())).ToList<GroupZombie>();
	___zombiegroup71 = (

(___groups71).Select(__ContextSymbol39 => new { ___a79 = __ContextSymbol39 })
.SelectMany(__ContextSymbol40=> (__ContextSymbol40.___a79.ZombieFollowers).Select(__ContextSymbol41 => new { ___c72 = __ContextSymbol41,
                                                      prev = __ContextSymbol40 })
.Select(__ContextSymbol42 => __ContextSymbol42.___c72)
.ToList<Zombie>())).ToList<Zombie>();
	if(((___zombiegroup71.Count) > (0)))
	{
...
return;	}
	case 8:
	Zombies = (___zombiegroup71).Concat(Zombies).ToList<Zombie>();
	s7 = -1;
return;	
	default: return;}}
...
return;	}else
	...
	goto case 3;	}
	case 3:
	___x91 = Jeep.Value.MultiplierBonus;
	if(((___x91) > (1.1f)))
	{
...
(Gasstations).Select(__ContextSymbol43 => new { ___a1010 = __ContextSymbol43 })
.Where(__ContextSymbol44 => __ContextSymbol44.___a1010.RepairZonE.Refill_Resources)
.Select(__ContextSymbol45 => __ContextSymbol45.___a1010)
.ToList<Gasstation>()).ToList<Gasstation>();
	if(((___j101.Count) > (0)))
	{
...
(new Cons<System.Int32>(850,(new Cons<System.Int32>(200,(new Cons<System.Int32>(60,(new Cons<System.Int32>(90,(new Cons<System.Int32>(25,(new Empty<System.Int32>()).ToList<System.Int32>())).ToList<System.Int32>())).ToList<System.Int32>())).ToList<System.Int32>())).ToList<System.Int32>())).ToList<System.Int32>()).ToList<System.Int32>();
		isModel = bs;
		TypeWeapon = sts;
		MaxSteering = ___MaxSteeringList00[___rnd00];
		MaxSpeed = ___MaxSpeedList00[___rnd00];
		Hull = ___HullList00[___rnd00];
		Health = ___HealthList00[___rnd00];
		Fuel = ___FuelList00[___rnd00];
...
(world.Gasstations).Select(__ContextSymbol55 => new { ___a111 = __ContextSymbol55 })
.Where(__ContextSymbol56 => __ContextSymbol56.___a111.RepairZonE.isEntered)
.Select(__ContextSymbol57 => __ContextSymbol57.___a111)
.ToList<Gasstation>()).ToList<Gasstation>();
...
return;	
	...
	case -1:
	___j24 = world.Jeep.Value.truckRigidBody.velocity.z;
	motor = motor;
	s2 = -1;
return;	
	default: return;}}
...
Enumerable.Empty<Barrel>()).ToList<Barrel>();
  ...
  set{UnityGasstation.Destroyed = value; }
	...
	public System.Boolean Destroyed2{  get { return UnityGasstation.Destroyed2; }
  set{UnityGasstation.Destroyed2 = value; }
 }
	public List<GroupZombie> GroupZombies;
	public UnityEngine.Vector3 Position{  get { return UnityGasstation.Position; }
 }
	public Repair2 RepairZonE;
...
(Blocations).Select(__ContextSymbol64 => new { ___a013 = __ContextSymbol64 })
.Select(__ContextSymbol65 => new Barrel(__ContextSymbol65.___a013))
...
(Barrels).Select(__ContextSymbol66 => new { ___a114 = __ContextSymbol66 })
.Where(__ContextSymbol67 => !(__ContextSymbol67.___a114.Destroyed))
.Select(__ContextSymbol68 => __ContextSymbol68.___a114)
.ToList<Barrel>()).ToList<Barrel>();
	Barrels = ___x13;
	s1 = -1;
return;	
...
(SP2).Select(__ContextSymbol71 => new { ___a415 = __ContextSymbol71 })
.Select(__ContextSymbol72 => __ContextSymbol72.___a415)
...
return;	}else
	...
	goto case 2;	}
	case 2:
	if(!(((Counter) == (((ZombieSpawnpoints.Count) - (1))))))
	{
...
public Repair2()
 ...
 frame = World.frame;
		...
		public System.Boolean Destroyed{  get { return UnityCheckpoint.Destroyed; }
  set{UnityCheckpoint.Destroyed = value; }
 }
	public System.Boolean Refill_Resources;
	public System.Single Show{  get { return UnityCheckpoint.Show; }
  set{UnityCheckpoint.Show = value; }
 }
  ...
  set{UnityCheckpoint.tag = value; }
	...
	public UnityEngine.TextMesh tex{  get { return UnityCheckpoint.tex; }
  set{UnityCheckpoint.tex = value; }
 }
...
(___axl10).Select(__ContextSymbol74 => new { ___a116 = __ContextSymbol74 })
.Where(__ContextSymbol75 => __ContextSymbol75.___a116.motor)
.Select(__ContextSymbol76 => __ContextSymbol76.___a116.leftWheel)
...
Enumerable.Empty<GroupZombie>()).ToList<GroupZombie>();
  ...
  set{UnityLandscape.useGUILayout = value; }
	...
	public List<System.Int32> ___j35;
...
(Streetlights_cnv).Select(__ContextSymbol86 => new { ___a117 = __ContextSymbol86 })
.Where(__ContextSymbol87 => !(__ContextSymbol87.___a117.Destroyed))
.Select(__ContextSymbol88 => __ContextSymbol88.___a117)
...
(Spawnpoints2).Select(__ContextSymbol89 => new { ___a218 = __ContextSymbol89 })
.Select(__ContextSymbol90 => __ContextSymbol90.___a218)
.ToList<UnityEngine.Transform>()).ToList<UnityEngine.Transform>();
...
(Enumerable.Range(0,(1) + ((3) - (0))).ToList<System.Int32>()).Select(__ContextSymbol91 => new { ___a319 = __ContextSymbol91 })
.Where(__ContextSymbol92 => ((!(((__ContextSymbol92.___a319) == (___random_spawnp30)))) || (!(((__ContextSymbol92.___a319) == (___random_pickup30))))))
.Select(__ContextSymbol93 => __ContextSymbol93.___a319)
.ToList<System.Int32>()).ToList<System.Int32>();
	___spo230 = (Spawnpoints)[___j35.Head()];
...
(Enumerable.Range(0,(1) + ((3) - (0))).ToList<System.Int32>()).Select(__ContextSymbol110 => new { ___a120 = __ContextSymbol110 })
.Select(__ContextSymbol111 => new BonusAndResource(___plist10[__ContextSymbol111.___a120],___Slist10[__ContextSymbol111.___a120],p))
...
(BonusAndResources).Select(__ContextSymbol112 => new { ___a221 = __ContextSymbol112 })
.Where(__ContextSymbol113 => ((__ContextSymbol113.___a221.Destroyed) == (false)))
.Select(__ContextSymbol114 => __ContextSymbol114.___a221)
.ToList<BonusAndResource>()).ToList<BonusAndResource>();
...
Enumerable.Empty<Light>()).ToList<Light>();
	...
	public System.Boolean FirstFrame;
  ...
  set{UnityEquipment.useGUILayout = value; }
	...
	public List<Ammo> ___j06;
	public List<ControllerRazor> ___pl10;
	public List<System.String> ___j17;
	...
	public System.Int32 ___n10;
	public System.Int32 ___num10;
	...
	public System.Int32 ___agnum10;
	...
	public List<Light> ___j49;
	public List<Light> ___rig40;
	public System.Boolean ___right40;
	public List<Light> ___lef40;
	public System.Boolean ___left40;
	public List<Gun> ___r43;
	public List<System.String> ___fdsa43;
	public System.Single count_down26;
	public List<Light> ___j510;
	public List<Light> ___rig51;
	public System.Boolean ___right51;
	public List<Light> ___lef51;
	public System.Boolean ___left51;
	public void Update(float dt, World world) {
frame = World.frame;
...
(Ammos).Select(__ContextSymbol131 => new { ___a022 = __ContextSymbol131 })
.Select(__ContextSymbol132 => new Ammo(__ContextSymbol132.___a022.Item1,__ContextSymbol132.___a022.Item2))
...
(Enumerable.Range(0,(1) + (((HR.Count) - (1)) - (0))).ToList<System.Int32>()).Select(__ContextSymbol134 => new { ___a123 = __ContextSymbol134 })
.Select(__ContextSymbol135 => new Gun(__ContextSymbol135.___a123,___pl10.Head(),___j17.Head(),AllAmmo[__ContextSymbol135.___a123]))
.ToList<Gun>()).ToList<Gun>();
	___y10 = (

(Enumerable.Range(0,(1) + (((HL.Count) - (1)) - (0))).ToList<System.Int32>()).Select(__ContextSymbol136 => new { ___a124 = __ContextSymbol136 })
.Select(__ContextSymbol137 => new Gun(__ContextSymbol137.___a124,___pl10[1],___j17[1],AllAmmo[__ContextSymbol137.___a124]))
.ToList<Gun>()).ToList<Gun>();
	___AcCount10 = (

(ActiveGuns).Select(__ContextSymbol138 => new { ___a125 = __ContextSymbol138 })
.Select(__ContextSymbol139 => __ContextSymbol139.___a125.GunNumber)
.ToList<System.Int32>()).ToList<System.Int32>();
...
Enumerable.Empty<System.Int32>()).ToList<System.Int32>();	}
	...
	case 25:
	___n10 = (___ac10)[1];
	___num10 = ((___n10) + (___x16.Count));
	___AG10 = (

(new Cons<Gun>(___AllGunslist10[___ac10[0]],(new Cons<Gun>(___AllGunslist10[___num10],(new Empty<Gun>()).ToList<Gun>())).ToList<Gun>())).ToList<Gun>()).ToList<Gun>();
	___NotAG10 = (

(___AllGunslist10).Select(__ContextSymbol142 => new { ___a126 = __ContextSymbol142 })
.Where(__ContextSymbol143 => !(___AG10.Contains(__ContextSymbol143.___a126)))
.Select(__ContextSymbol144 => __ContextSymbol144.___a126)
.ToList<Gun>()).ToList<Gun>();
	___fdsa10 = (

(___NotAG10).Select(__ContextSymbol145 => new { ___a127 = __ContextSymbol145 })
.Select(__ContextSymbol146 => ((("Nummer:") + (__ContextSymbol146.___a127.GunNumber)) + (" Controller:")) + (__ContextSymbol146.___a127.GunController.JoystickName))
.ToList<System.String>()).ToList<System.String>();
	ActiveGuns = ___AG10;
...
(ActiveGuns).Select(__ContextSymbol148 => new { ___a128 = __ContextSymbol148 })
.Select(__ContextSymbol149 => __ContextSymbol149.___a128.GunController.JoystickName)
.ToList<System.String>()).ToList<System.String>();
	___agnum10 = ___ac10.Head();
	if(!(((___gunhand10.Head()) == ("Hydra1 - Left"))))
	{

	___AG11 = (

(new Cons<Gun>(___AllGunslist10[___agnum10],(new Empty<Gun>()).ToList<Gun>())).ToList<Gun>()).ToList<Gun>();	}else
	{

	___AG11 = (

(new Cons<Gun>(___AllGunslist10[(___agnum10) + (HR.Count)],(new Empty<Gun>()).ToList<Gun>())).ToList<Gun>()).ToList<Gun>();	}
	___NotAG11 = (

(___AllGunslist10).Select(__ContextSymbol152 => new { ___a129 = __ContextSymbol152 })
.Where(__ContextSymbol153 => !(___AG11.Contains(__ContextSymbol153.___a129)))
.Select(__ContextSymbol154 => __ContextSymbol154.___a129)
.ToList<Gun>()).ToList<Gun>();
	if(!(((___gunhand10.Head()) == ("Hydra1 - Left"))))
	{

	___AF10 = ActiveFlashs;	}else
	{

	___AF10 = NotActiveFlashs;	}
	if(!(((___gunhand10.Head()) == ("Hydra1 - Left"))))
	{

	___NAF10 = NotActiveFlashs;	}else
	{

	___NAF10 = ActiveFlashs;	}
	___AllF10 = (___AF10).Concat(___NAF10).ToList<Light>();
	___fdsa11 = (

(___NotAG11).Select(__ContextSymbol155 => new { ___a130 = __ContextSymbol155 })
.Select(__ContextSymbol156 => ((("Nummer:") + (__ContextSymbol156.___a130.GunNumber)) + (" Controller:")) + (__ContextSymbol156.___a130.GunController.JoystickName))
.ToList<System.String>()).ToList<System.String>();
	ActiveGuns = ___AG11;
...
(___AllGunslist10).Select(__ContextSymbol158 => new { ___a131 = __ContextSymbol158 })
.Where(__ContextSymbol159 => !(___AG12.Contains(__ContextSymbol159.___a131)))
.Select(__ContextSymbol160 => __ContextSymbol160.___a131)
.ToList<Gun>()).ToList<Gun>();
	___AF11 = (
...
(new Cons<Light>(new Light(___pl10[0]),(new Empty<Light>()).ToList<Light>())).ToList<Light>()).ToList<Light>();
	___AllF11 = (___AF11).Concat(___NAF11).ToList<Light>();
	___fdsa12 = (

(___NotAG12).Select(__ContextSymbol163 => new { ___a132 = __ContextSymbol163 })
.Select(__ContextSymbol164 => ((("Nummer:") + (__ContextSymbol164.___a132.GunNumber)) + (" Controller:")) + (__ContextSymbol164.___a132.GunController.JoystickName))
.ToList<System.String>()).ToList<System.String>();
	ActiveGuns = ___AG12;
...
(ActiveGuns).Select(__ContextSymbol165 => new { ___a233 = __ContextSymbol165 })
.Where(__ContextSymbol166 => !(((__ContextSymbol166.___a233.GunController.ECB) == (""))))
.Select(__ContextSymbol167 => __ContextSymbol167.___a233)
.ToList<Gun>()).ToList<Gun>();
	___j28 = (

(ActiveFlashs).Select(__ContextSymbol168 => new { ___a234 = __ContextSymbol168 })
.Where(__ContextSymbol169 => ((__ContextSymbol169.___a234.LightController.ECB) == ("other")))
.Select(__ContextSymbol170 => __ContextSymbol170.___a234)
.ToList<Light>()).ToList<Light>();
	if(((((___q21.Count) > (0))) && (!(((___j28.Count) > (0))))))
	{
...
return;
	case 42:
	if(((((___j28.Count) > (0))) && (!(((___q21.Count) > (0))))))
	{
	...
	case 40:
	GunControllerPressed = (new Nothing<Gun>());
	LightControllerPressed = (new Just<Light>(___j28.Head()));
	s2 = -1;
return;
	case 41:
	GunControllerPressed = (new Nothing<Gun>());
...
(ActiveGuns).Select(__ContextSymbol171 => new { ___a335 = __ContextSymbol171 })
.Where(__ContextSymbol172 => !(((__ContextSymbol172.___a335.GunController.JoystickName) == (___Joystickname30))))
.Select(__ContextSymbol173 => __ContextSymbol173.___a335)
.ToList<Gun>()).ToList<Gun>();
	___OldActiveFlash30 = (

(ActiveFlashs).Select(__ContextSymbol174 => new { ___a336 = __ContextSymbol174 })
.Where(__ContextSymbol175 => !(((__ContextSymbol175.___a336.LightController.JoystickName) == (___Joystickname30))))
.Select(__ContextSymbol176 => __ContextSymbol176.___a336)
.ToList<Light>()).ToList<Light>();
	if(GunControllerPressed.IsSome)
	{
...
(AllGuns).Select(__ContextSymbol177 => new { ___a337 = __ContextSymbol177 })
.Where(__ContextSymbol178 => ((__ContextSymbol178.___a337.GunController.JoystickName) == (___Joystickname30)))
.Select(__ContextSymbol179 => __ContextSymbol179.___a337)
.ToList<Gun>()).ToList<Gun>();
...
(ActiveGuns).Select(__ContextSymbol180 => new { ___a338 = __ContextSymbol180 })
.Where(__ContextSymbol181 => ((__ContextSymbol181.___a338.GunController.JoystickName) == (___Joystickname30)))
.Select(__ContextSymbol182 => __ContextSymbol182.___a338)
.ToList<Gun>()).ToList<Gun>();
	___changingLight30 = (

(AllFlashs).Select(__ContextSymbol183 => new { ___a339 = __ContextSymbol183 })
.Where(__ContextSymbol184 => ((__ContextSymbol184.___a339.LightController.JoystickName) == (___Joystickname30)))
.Select(__ContextSymbol185 => __ContextSymbol185.___a339)
.ToList<Light>()).ToList<Light>();
...
(ActiveGuns).Select(__ContextSymbol188 => new { ___a340 = __ContextSymbol188 })
.Where(__ContextSymbol189 => ((__ContextSymbol189.___a340.GunController.JoystickName) == (___Joystickname30)))
.Select(__ContextSymbol190 => __ContextSymbol190.___a340)
.ToList<Gun>()).ToList<Gun>();
	___nextGunNumber30 = ((((___GunNumber30) + (1))) % (___Listsize30));
	___check30 = (

(ActiveGuns).Select(__ContextSymbol191 => new { ___a341 = __ContextSymbol191 })
.Where(__ContextSymbol192 => ((__ContextSymbol192.___a341.GunNumber) == (___nextGunNumber30)))
.Select(__ContextSymbol193 => __ContextSymbol193.___a341)
.ToList<Gun>()).ToList<Gun>();
...
(___changingjoystick30).Select(__ContextSymbol194 => new { ___a342 = __ContextSymbol194 })
.Where(__ContextSymbol195 => ((__ContextSymbol195.___a342.GunNumber) == (___othernumber30)))
.Select(__ContextSymbol196 => __ContextSymbol196.___a342)
.ToList<Gun>()).ToList<Gun>();
...
(___changingjoystick30).Select(__ContextSymbol201 => new { ___a343 = __ContextSymbol201 })
.Where(__ContextSymbol202 => ((__ContextSymbol202.___a343.GunNumber) == (___nextGunNumber30)))
.Select(__ContextSymbol203 => __ContextSymbol203.___a343)
.ToList<Gun>()).ToList<Gun>();
	if(((___Joystickname30) == (TransformHR.name)))
	{
...
(ActiveGuns).Select(__ContextSymbol208 => new { ___a344 = __ContextSymbol208 })
.Where(__ContextSymbol209 => ((__ContextSymbol209.___a344.GunController.JoystickName) == (___Joystickname30)))
.Select(__ContextSymbol210 => __ContextSymbol210.___a344)
.ToList<Gun>()).ToList<Gun>();
	___prevGunNumber30 = ((((((___GunNumber30) + (___Listsize30))) - (1))) % (___Listsize30));
	___check31 = (

(ActiveGuns).Select(__ContextSymbol211 => new { ___a345 = __ContextSymbol211 })
.Where(__ContextSymbol212 => ((__ContextSymbol212.___a345.GunNumber) == (___prevGunNumber30)))
.Select(__ContextSymbol213 => __ContextSymbol213.___a345)
.ToList<Gun>()).ToList<Gun>();
...
(___changingjoystick30).Select(__ContextSymbol214 => new { ___a346 = __ContextSymbol214 })
.Where(__ContextSymbol215 => ((__ContextSymbol215.___a346.GunNumber) == (___othernumber31)))
.Select(__ContextSymbol216 => __ContextSymbol216.___a346)
.ToList<Gun>()).ToList<Gun>();
	if(((___Joystickname30) == (TransformHR.name)))
	{
...
(___changingjoystick30).Select(__ContextSymbol221 => new { ___a347 = __ContextSymbol221 })
.Where(__ContextSymbol222 => ((__ContextSymbol222.___a347.GunNumber) == (___prevGunNumber30)))
.Select(__ContextSymbol223 => __ContextSymbol223.___a347)
.ToList<Gun>()).ToList<Gun>();
	if(((___Joystickname30) == (TransformHR.name)))
	{
...
(AllFlashs).Select(__ContextSymbol228 => new { ___a348 = __ContextSymbol228 })
.Where(__ContextSymbol229 => ((__ContextSymbol229.___a348.LightController.JoystickName) == (___Joystickname30)))
.Select(__ContextSymbol230 => __ContextSymbol230.___a348)
.ToList<Light>()).ToList<Light>();
	___currActiveGunNumber30 = (

(ActiveGuns).Select(__ContextSymbol231 => new { ___a349 = __ContextSymbol231 })
.Select(__ContextSymbol232 => __ContextSymbol232.___a349.GunNumber)
.ToList<System.Int32>()).ToList<System.Int32>();
...
(NotActiveGuns).Select(__ContextSymbol233 => new { ___a350 = __ContextSymbol233 })
.Where(__ContextSymbol234 => ((((__ContextSymbol234.___a350.GunController.JoystickName) == (___Joystickname30))) && (!(((__ContextSymbol234.___a350.GunNumber) == (___currActiveGunNumber30.Head()))))))
.Select(__ContextSymbol235 => __ContextSymbol235.___a350)
.ToList<Gun>()).ToList<Gun>();
	ActiveGuns = (
...
(NotActiveGuns).Select(__ContextSymbol238 => new { ___a351 = __ContextSymbol238 })
.Where(__ContextSymbol239 => ((__ContextSymbol239.___a351.GunController.JoystickName) == (___Joystickname30)))
.Select(__ContextSymbol240 => __ContextSymbol240.___a351)
.ToList<Gun>()).ToList<Gun>();
	ActiveGuns = (
...
(ActiveGuns).Select(__ContextSymbol243 => new { ___a452 = __ContextSymbol243 })
.Where(__ContextSymbol244 => ((__ContextSymbol244.___a452.GunController.JoystickName) == (___Joystickname41)))
.Select(__ContextSymbol245 => __ContextSymbol245.___a452)
.ToList<Gun>()).ToList<Gun>();
...
(AllFlashs).Select(__ContextSymbol246 => new { ___a453 = __ContextSymbol246 })
.Where(__ContextSymbol247 => !(ActiveFlashs.Contains(__ContextSymbol247.___a453)))
.Select(__ContextSymbol248 => __ContextSymbol248.___a453)
.ToList<Light>()).ToList<Light>();
	___rig40 = (

(ActiveFlashs).Select(__ContextSymbol249 => new { ___a454 = __ContextSymbol249 })
.Where(__ContextSymbol250 => !(((__ContextSymbol250.___a454.LightController.JoystickName) == ("Hydra1 - Left"))))
.Select(__ContextSymbol251 => __ContextSymbol251.___a454)
.ToList<Light>()).ToList<Light>();
	if(((___rig40.Count) > (0)))
	{

	___right40 = true;	}else
	{

	___right40 = false;	}
	___lef40 = (

(ActiveFlashs).Select(__ContextSymbol252 => new { ___a455 = __ContextSymbol252 })
.Where(__ContextSymbol253 => !(((__ContextSymbol253.___a455.LightController.JoystickName) == ("Hydra1 - Right"))))
.Select(__ContextSymbol254 => __ContextSymbol254.___a455)
.ToList<Light>()).ToList<Light>();
	if(((___lef40.Count) > (0)))
	{
...
(AllGuns).Select(__ContextSymbol255 => new { ___a456 = __ContextSymbol255 })
.Where(__ContextSymbol256 => !(ActiveGuns.Contains(__ContextSymbol256.___a456)))
.Select(__ContextSymbol257 => __ContextSymbol257.___a456)
.ToList<Gun>()).ToList<Gun>();
	___fdsa43 = (

(___r43).Select(__ContextSymbol258 => new { ___a457 = __ContextSymbol258 })
.Select(__ContextSymbol259 => ((("Nummer:") + (__ContextSymbol259.___a457.GunNumber)) + (" Controller:")) + (__ContextSymbol259.___a457.GunController.JoystickName))
.ToList<System.String>()).ToList<System.String>();
	NotActiveGuns = ___r43;
	asdf = ___fdsa43;
	NotActiveFlashs = ___j49;
	sap = (

(new Cons<System.Boolean>(___right40,(new Cons<System.Boolean>(___left40,(new Empty<System.Boolean>()).ToList<System.Boolean>())).ToList<System.Boolean>())).ToList<System.Boolean>()).ToList<System.Boolean>();
	s4 = -1;
return;	
	default: return;}}
	...
	case -1:
	if(!(((world.W_Refill_Resources) || (FirstFrame))))
	{
...
(AllFlashs).Select(__ContextSymbol261 => new { ___a558 = __ContextSymbol261 })
.Where(__ContextSymbol262 => !(ActiveFlashs.Contains(__ContextSymbol262.___a558)))
.Select(__ContextSymbol263 => __ContextSymbol263.___a558)
.ToList<Light>()).ToList<Light>();
	___rig51 = (

(ActiveFlashs).Select(__ContextSymbol264 => new { ___a559 = __ContextSymbol264 })
.Where(__ContextSymbol265 => !(((__ContextSymbol265.___a559.LightController.JoystickName) == ("Hydra1 - Left"))))
.Select(__ContextSymbol266 => __ContextSymbol266.___a559)
.ToList<Light>()).ToList<Light>();
	if(((___rig51.Count) > (0)))
	{

	___right51 = true;	}else
	{

	___right51 = false;	}
	___lef51 = (

(ActiveFlashs).Select(__ContextSymbol267 => new { ___a560 = __ContextSymbol267 })
.Where(__ContextSymbol268 => !(((__ContextSymbol268.___a560.LightController.JoystickName) == ("Hydra1 - Right"))))
.Select(__ContextSymbol269 => __ContextSymbol269.___a560)
.ToList<Light>()).ToList<Light>();
	if(((___lef51.Count) > (0)))
	{
	...
	___left51 = false;	}
	NotActiveFlashs = ___j510;
	sap = (

(new Cons<System.Boolean>(___right51,(new Cons<System.Boolean>(___left51,(new Empty<System.Boolean>()).ToList<System.Boolean>())).ToList<System.Boolean>())).ToList<System.Boolean>()).ToList<System.Boolean>();
	s5 = -1;
return;	
	default: return;}}
...
Enumerable.Empty<BazookaBullet>()).ToList<BazookaBullet>();
  ...
  set{UnityGun.MuzzleSound = value; }
	...
	public UnityEngine.ParticleSystem Muzzleflash{  get { return UnityGun.Muzzleflash; }
  set{UnityGun.Muzzleflash = value; }
 }
  ...
  set{UnityGun.enabled = value; }
	...
	public UnityEngine.AudioSource gunShot{  get { return UnityGun.gunShot; }
  set{UnityGun.gunShot = value; }
 }
...
return;	
	...
	case -1:
	___gui70 = (((((((("") + (InMag))) + (" / "))) + (NotInMag))) + (""));
	MagazineGUI = ___gui70;
	s7 = -1;
return;	
	default: return;}}
...
(BazookaBullets).Select(__ContextSymbol277 => new { ___a1061 = __ContextSymbol277 })
.Where(__ContextSymbol278 => ((__ContextSymbol278.___a1061.Destroyed) == (false)))
.Select(__ContextSymbol279 => __ContextSymbol279.___a1061)
...
public Light(ControllerRazor LC)
	{JustEntered = false;
 frame = World.frame;
		System.String ___j011;
		___j011 = LC.name;
		System.Single ___startb00;
		___startb00 = 100.01f;
		UnityFlashLight = UnityFlashLight.Find(___j011);
		Max = ___startb00;
		LightController = LC;
		Battery = ___startb00;
...
(U_Zombies).Select(__ContextSymbol282 => new { ___a063 = __ContextSymbol282 })
.Select(__ContextSymbol283 => new Zombie(__ContextSymbol283.___a063))
.ToList<Zombie>()).ToList<Zombie>();
...
public Zombie(UnityEngine.Transform trans)
 ...
 frame = World.frame;
		...
		public System.Boolean Anim{  get { return UnityZombie2.Anim; }
  set{UnityZombie2.Anim = value; }
 }
  ...
  set{UnityZombie2.impacts = value; }
	...
	public UnityEngine.Animator motor1{  get { return UnityZombie2.motor1; }
  set{UnityZombie2.motor1 = value; }
 }
  ...
  set{UnityZombie2.useGUILayout = value; }
	...
	public System.Single count_down32;
	public System.Single count_down33;
	public System.Single ___j512;
	public void Update(float dt, World world) {
frame = World.frame;
...
return;	}	
	...
	case -1:
	if(((8f) > (((world.Jeep.Value.PrevVelocity.z) * (-1f)))))
	{

	___j512 = 8f;	}else
	{

	___j512 = ((7f) + (((world.Jeep.Value.PrevVelocity.z) * (-0.3f))));	}
	if(((((___j512) > (UnityEngine.Vector3.Distance(world.Jeep.Value.Position,Position)))) && (((Life) > (0f)))))
	{
...
public ZombieGroupDestroyer(System.Single a, UnityEngine.Vector3 b)
 ...
 frame = World.frame;
	...
	public UnityEngine.GameObject Wall{  get { return UnityDestroyer.Wall; }
  set{UnityDestroyer.Wall = value; }
 }
