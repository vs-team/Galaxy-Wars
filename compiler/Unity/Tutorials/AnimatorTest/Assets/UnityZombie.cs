...
public class UnityZombie : MonoBehaviour
{
  ...
  {
    GameObject zombies = GameObject.Find("Ragdoll Zombie") as GameObject;
    return zombies.GetComponent<UnityZombie>() as UnityZombie;
  }
  ...
  public string hitBodyPart
  {
    get
    {
      ...
      int layermask = 1 << 8;
      Physics.Raycast(ray, out hit, 100, layermask);                        // Gun Distance
