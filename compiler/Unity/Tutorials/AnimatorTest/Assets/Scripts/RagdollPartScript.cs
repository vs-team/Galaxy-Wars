...
public class RagdollPartScript : MonoBehaviour {
	//Declare a reference to the main script (of type ZombieAnimatorController).
	//This will be set by the code that adds this script to all ragdoll parts
	public ZombieAnimatorController mainScript;
	...
	void OnCollisionEnter(Collision collision)
	{
		...
		//		//increase the main script's score variable (see ZombieAnimatorController.cs)
