...
public class UnityZombie : MonoBehaviour
{
    ...
    {
        var Zombie = GameObject.Instantiate(Resources.Load("Model/Zombie"), pos - (new Vector3(Random.value * 4.0f, 0.0f, Random.value * 4.0f)), Quaternion.identity) as GameObject;
