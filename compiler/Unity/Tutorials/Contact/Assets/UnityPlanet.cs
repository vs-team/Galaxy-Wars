...
public class UnityPlanet : MonoBehaviour
{
  ...
  private Quaternion targetingPlayerStartingRotation;
	...
	public Color OwnerColor
	{
		...
		set
		{
			...
			//Debug.Log(value);
			this.gameObject.transform.FindChild("Owner").gameObject.GetComponent<Renderer>().material.color = newColor;
			ownerColor = newColor; 
		}
	}
  ...
  public Color TargetingPlayerColor
  {
    ...
    set
    {
      Color newColor = value;
      //Debug.Log(value);
      this.gameObject.transform.FindChild("TargetingPlayer").gameObject.GetComponent<Renderer>().material.color = newColor;
