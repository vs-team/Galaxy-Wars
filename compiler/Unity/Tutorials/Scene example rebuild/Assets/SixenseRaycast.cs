...
public class SixenseRaycast : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Controller controller = SixenseInput.GetController(Hand);
    ...
    protected virtual void UpdateObject(Controller controller)
    {
    ...
    protected void UpdatePosition(Controller controller)
    {
    ...
    protected void UpdateRotation(Controller controller)
    {
